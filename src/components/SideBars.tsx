...
export default function CollapseSidebar( {tabs}: SidebarProps) {
  return (
    <>
...
export function PushSidebar( {tabs}: SidebarProps){
  return (
    <>
      <div className="col-auto px-0">
        <div id="sidebar" className="collapse collapse-horizontal show border-end">
          <div id="sidebar-nav" className="list-group border-0 rounded-0 text-sm-start min-vh-100">
            {tabs.map((tab: string) => (
            <a className='list-group-item border-end-0 d-inline-block text-truncate' key={tab}>
